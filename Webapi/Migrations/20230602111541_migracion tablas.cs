        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Genero = table.Column<string>(type: "nvarchar(2)", maxLength: 2, nullable: true),
                    Nombre = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
                    PrimerApellido = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "EncabezadoOrdenVentas",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Cedula = table.Column<string>(type: "nvarchar(12)", maxLength: 12, nullable: true),
                    PersonaCedula = table.Column<string>(type: "nvarchar(12)", nullable: true),
                    IdSupermercado = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
                    MetodoPago = table.Column<string>(type: "nvarchar(9)", maxLength: 9, nullable: true),
                    TipoCambio = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    FechaOrden = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EncabezadoOrdenVentas", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NombreProducto = table.Column<string>(type: "nvarchar(60)", maxLength: 60, nullable: true),
                    ...
                    PrecioImpuestoUnitario = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Cantidad = table.Column<int>(type: "int", nullable: false),
                    PrecioTotalImpuestos = table.Column<decimal>(type: "decimal(18,2)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DetalleOrdenVenta", x => x.Id);
                    table.ForeignKey(
